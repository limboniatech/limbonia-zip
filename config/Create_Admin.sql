...
CREATE TABLE IF NOT EXISTS TicketHistory (
  ...
  CategoryIDFrom INTEGER UNSIGNED NULL DEFAULT 0,
  CategoryIDTo INTEGER UNSIGNED NULL DEFAULT 0,
  ParentIDFrom INTEGER UNSIGNED NULL DEFAULT 0,
  ParentIDTo INTEGER UNSIGNED NULL DEFAULT 0,
  CustomerIDFrom INTEGER UNSIGNED NULL,
  CustomerIDTo INTEGER UNSIGNED NULL,
  ...
  SubjectFrom VARCHAR(255) NULL,
  SubjectTo VARCHAR(255) NULL,
