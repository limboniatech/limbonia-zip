...
if ($controller->post['reset'] == 'Yes')
{
  ...
  echo "<div class=\"field\"><span class=\"blankLabel\"><span class=\"data\"><button type=\"submit\" name=\"Reset\">Yes</button>&nbsp;&nbsp;&nbsp;&nbsp;<a class=\"item\" href=\"" . $module->generateUri($currentItem->id) . "\"><button name=\"No\">No</button></a></span></div>\n";
  echo "</form>\n";
}
else
{
